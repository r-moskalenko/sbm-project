package com.soa.labs.gatewayservice.controller;

import com.soa.labs.gatewayservice.dto.ApiLimiterRequest;
import com.soa.labs.gatewayservice.dto.ApiLimiterResponse;
...
public class ApiLimiterController {
    ...
    public Mono<?> createApiLimiter(
            @RequestBody @Validated ApiLimiterRequest createOrUpdateApiLimiter) {
